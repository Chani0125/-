...
#define _EMA_ALPHA1 0.6
#define _EMA_ALPHA2 0.8
...
void loop() {
  ...
  dist_ema1 = dist_raw * _EMA_ALPHA1 + dist_ema1 * (1 - _EMA_ALPHA1);
  dist_ema2 = dist_raw * _EMA_ALPHA2 + dist_ema2 * (1 - _EMA_ALPHA2);

  // output the distance to the serial port
  Serial.print("Min:");   Serial.print(_DIST_MIN);
  Serial.print(",raw:");  Serial.print(dist_raw);
  Serial.print(",ema:");  Serial.print(dist_ema);
  Serial.print(",ema1:");  Serial.print(dist_ema1);
  Serial.print(",ema2:");  Serial.print(dist_ema2);
